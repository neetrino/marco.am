...
class AdminService {
  ...
  moveCategory = adminCategoriesService.moveCategory.bind(adminCategoriesService);
  reorderCategory = adminCategoriesService.reorderCategory.bind(adminCategoriesService);
