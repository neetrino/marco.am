...
export function MarcoLogo() {
  return (
    ...
    >
      <span className="relative aspect-[83/73] h-9 w-auto shrink-0 overflow-hidden md:h-11 min-[1800px]:h-[64px]">
        <Image
          ...
          priority
          sizes="(min-width: 1800px) 64px, (min-width: 768px) 44px, 36px"
        />
      </span>
    </Link>
  );
