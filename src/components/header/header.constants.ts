...
/**
 * Subcategory grid — 4 columns only on large desktops (min-width 1680px); 13″ laptops
 * (~1280–1440px logical) stay at 3 columns (sheet is 90% width). Tailwind JIT — keep the
 * `min-[1680px]` literal below in sync with that breakpoint.
 */
...
export const HEADER_MEGA_MENU_CONTENT_PADDING_CLASS = 'px-5 md:px-6';
 ...
 */
const HEADER_ROW2_BAR_HEIGHT_CLASS = 'h-10';
...
const HEADER_SEARCH_SUBMIT_HEIGHT_CLASS = HEADER_ROW2_BAR_HEIGHT_CLASS;
...
const HEADER_TOOLBAR_ICON_BUTTON_CLASS = 'h-10 w-10 shrink-0';
...
const HEADER_CART_BUTTON_CLASS =
