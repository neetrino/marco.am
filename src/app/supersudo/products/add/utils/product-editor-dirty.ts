 ...
 *
 * Description/subtitle are intentionally NOT gated — the payload is small JSON,
 * and skipping them caused silent drops when the baseline raced with edits.
 */
export const GATED_SECTIONS = ['media', 'pricing'] as const;
