...
import { ProductSubtitleHtmlEditor } from './ProductSubtitleHtmlEditor';
...
export function ProductDescriptionTab({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden">
      <section className="shrink-0 rounded-xl border border-slate-200/80 bg-white px-4 py-3 lg:px-5">
        <div className="mb-2">
          <h3 className="text-sm font-medium text-marco-black">
            {t('admin.products.add.shortDescriptionTitle')}
          </h3>
          <p className="mt-0.5 text-xs leading-snug text-slate-500">
            {t('admin.products.add.shortDescriptionHint')}
          </p>
        </div>
        <ProductSubtitleHtmlEditor value={subtitleHtml} onChange={onSubtitleChange} />
      </section>

      <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-slate-200/80 bg-white">
        <div className="flex shrink-0 items-start justify-between gap-3 px-4 py-3 lg:px-5">
          <div className="min-w-0">
            <h3 className="text-sm font-medium text-marco-black">
              {t('admin.products.add.specificationsTitle')}
            </h3>
            <p className="mt-0.5 text-xs leading-snug text-slate-500">
              {t('admin.products.add.specificationsHint')}
            </p>
          </div>
          <button
            type="button"
