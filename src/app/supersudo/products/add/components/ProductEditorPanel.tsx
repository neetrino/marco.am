...
export function ProductEditorPanel({ productId, onCancel, onSaved }: ProductEditorPanelProps) {
  ...
  return (
    <>
      <div className="sticky top-0 z-10 shrink-0 border-b border-marco-border/60 bg-white/95 px-5 py-3 backdrop-blur-sm">
        <ProductTypeTabs
          productType={formState.productType}
          onChange={formState.setProductType}
        />
      </div>
