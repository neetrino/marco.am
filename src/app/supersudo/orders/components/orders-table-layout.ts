/** Shared layout tokens for admin orders table (Armenian-friendly column widths). */
...
export const ORDER_TABLE_CLASS =
  'w-full min-w-[920px] table-fixed border-separate border-spacing-0';

export const ORDER_TABLE_HEAD_CLASS = 'sticky top-0 z-10';

export const ORDER_TABLE_HEAD_ROW_CLASS = 'border-b border-slate-200';
