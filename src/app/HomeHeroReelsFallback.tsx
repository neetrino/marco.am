/**
 * Visible shell while hero + reels data streams (same idea as shop PLP skeleton).
 */
export function HomeHeroReelsFallback() {
  const block = 'animate-pulse rounded-lg bg-slate-200 dark:bg-slate-600';
  ...
  return (
    ...
    >
      <div className="marco-header-container pt-8 sm:pt-11 lg:pt-10">
        <div className={`relative aspect-[399/288] w-full min-w-0 overflow-hidden rounded-[24px] md:aspect-[141/68] md:rounded-[32px] ${block}`} />
      </div>
